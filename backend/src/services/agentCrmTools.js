...
//
// These let an agent act on its OWN conversation's contact inside RideMitr WA's
...
function buildCrmTools({ waNumber, contactNumber }) {
  ...
  tools.push({
    ...
    description: "Save the customer's name onto their RideMitr WA CRM contact record. Call this once you learn their name so it shows on the Contacts page and chat.",
