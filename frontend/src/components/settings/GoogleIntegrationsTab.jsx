  ...
  return (
    <div style={{ flex: 1, padding: '32px 40px', overflowY: 'auto', fontFamily: FONT }}>
      ...
      <DeleteConfirmModal
        ...
        message={pendingDelete ? `This will revoke RideMitr WA's access to ${pendingDelete.accountLabel}. Any agent tools using this account will stop working until reconnected.` : ''}
