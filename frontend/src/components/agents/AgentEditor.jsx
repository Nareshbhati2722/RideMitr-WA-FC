              ...
              <label style={{ display: 'flex', alignItems: 'flex-start', gap: 10, cursor: 'pointer', marginTop: 14 }}>
                ...
                <div>
                  <div style={{ display: 'flex', alignItems: 'center', fontSize: 13, fontWeight: 600, color: C.text }}>
                    ...
                    <InfoDot text="When on, the agent can act on the chatting contact inside RideMitr WA — save their name, add tags, and set custom fields — so enquiries land in your CRM, not just a sheet. The agent only ever touches the contact it's chatting with." />
                  </div>
                  <div style={{ fontSize: 11, color: C.textMuted, marginTop: 2 }}>
